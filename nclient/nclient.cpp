...
BEGIN_MESSAGE_MAP(CNclientApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CNclientApp::OnAppAbout)
END_MESSAGE_MAP()
...
CNclientApp::CNclientApp()
{
	...
	SetAppID(_T("nclient.AppID.NoVersion"));
...
int CNclientApp::ExitInstance()
{
	//TODO: handle additional resources you may have added
	return CWinApp::ExitInstance();
}

// CNclientApp message handlers
